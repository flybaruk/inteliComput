...
class DefaultPlayer(BasePlayer):
    """
    Implementação padrão do jogador que escolhe o alvo mais próximo.
    """
    ...
    def escolher_alvo(self, world, current_steps):
        ...
        # Se sem carga, procura o pacote mais próximo
        if self.cargo == 0 and world.packages:
            ...
            for pkg in world.packages:
                ...
                if d < best_dist:
                    ...
                    best_target = pkg
            return best_target
        # Se com carga, procura a meta mais próxima
...
class Maze:
    ...
    # ==============================================================
    # <<< LÓGICA DE FUNCIONAMENTO PRESERVADA: DIJKSTRA >>>
    # ==============================================================
    def dijkstra(self, start, goal):
        ...
        # Inicializa distâncias de forma mais eficiente
...
if __name__ == "__main__":
    ...
    parser.add_argument("--arquivo_saida", type=str, default="simulacao-BuscaDijkstra.csv", help="Nome do arquivo CSV de saída (D para Dijkstra).")
    ...
    with open(args.arquivo_saida, 'a', newline='') as csvfile:
        ...
        print(f"Executando {num_runs} simulação(ões) com Dijkstra. Timeout: {TIMEOUT_SECONDS}s. Saída: '{args.arquivo_saida}'...")
