...
class SmartPlayer(BasePlayer):
    ...
    def _evaluate_best_goal(self, world, current_steps, maze_solver):
        ...
        for goal in world.goals:
            path_to_goal = maze_solver.astar(self.position, goal["pos"])
    ...
    def game_loop(self):
        while self.running:
            ...
            if self.current_target is None:
                # A classe Maze (self) é passada para o player para que ele possa usar o A*
...
if __name__ == "__main__":
    ...
    parser.add_argument("--arquivo_saida", type=str, default="simulacao-SmartPlayer-As.csv", help="Nome do arquivo CSV de saída (Agente Inteligente).")
    ...
    with open(args.arquivo_saida, 'a', newline='') as csvfile:
        ...
        print(f"Executando {num_runs} simulação(ões) com SmartPlayer. Timeout: {TIMEOUT_SECONDS}s. Saída: '{args.arquivo_saida}'...")
